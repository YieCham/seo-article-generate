...
- Generic body Parts → topic-driven titles from outline + research; mention product name only when content naturally links to it (light touch, ≤1–2 mentions per Part); **H2 titles must read naturally** — semantic match to Topic is enough; do not paste the exact Topic into every Part heading; no keyword-stuffed H2s
